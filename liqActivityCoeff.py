...
# property to predict
property_to_predict = "LiquidActivityCoefficient"
...
#### Inputs for AsymMolal/Molar properties calculation #############################################

z = [55.5, 1.0, 1.0] # molal
...
liquid_phase_properties_asym = [
    "LiquidActivityCoefficientAsymMolal",
    "LiquidActivityCoefficientAsymMolalLn",
    "LiquidActivityCoefficientAsymMolar",
    "LiquidActivityCoefficientAsymMolarLn"
]
...
elif property_to_predict in liquid_phase_properties_asym:
    property_type = "liquid_phase_properties_asym"

else :
    property_type = "invalid type or flash properties"
    print(property_type)
...
if T_low > T_up or P_low > P_up :
    ...
    f_csv.write('T[K],P[Pa],' + property_to_predict + ',phase:' + phase + '\n')
    ...
    f_csv.write('P[Pa],' + property_to_predict + '\n')
    ...
    f_csv.write('T[K],P[Pa],' + property_to_predict + '\n')
...
elif property_type == "liquid_phase_properties_asym" :
    f_csv_firstline = 'T[K],P[Pa],'
    for compound in compounds :
        f_csv_firstline = f_csv_firstline + compound + ','
